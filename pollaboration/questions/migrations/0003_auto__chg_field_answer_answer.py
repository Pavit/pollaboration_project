...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'questions_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Answer.answer'
        db.alter_column(u'questions_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        ...
        u'questions.answer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'questions.question': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
