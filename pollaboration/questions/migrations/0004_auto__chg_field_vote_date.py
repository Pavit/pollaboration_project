...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'questions_vote', 'date', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Vote.date'
        db.alter_column(u'questions_vote', 'date', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'questions.answer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'questions.question': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
